        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <?php
                if (isset($_SESSION['user'])) {
                    echo '
                        <li class="nav-item">
                            <a class="nav-link" href="' . PATH . '/myth">' . lang('thesa.myth') . '</a>
                        </li>';
                echo '
                        <li class="nav-item">
                            <a class="nav-link  btn btn-outline-primary" style="text-decoration: none;" href="' . PATH . '/admin">' . lang('thesa.edit') . '</a>
                        </li>';
                }
                ?>

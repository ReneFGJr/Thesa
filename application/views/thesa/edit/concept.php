	...
	<div class="row">
		<div class="col-md-5">
			...
			if ((count($terms_bt) + $editar)  > 0) {
				...
				if (count($terms_bt) == 0)
					{
					echo ' <a href="#" onclick="newwin(\''.base_url('index.php/thesa/tg/'.$id_c.'/'.checkpost_link($id_c)).'\',800,500);">';
			...
			if ((count($terms_tr) +$editar)  > 0) {
				echo '<h4>';
				echo msg('concept_TR');
				echo ' <a href="#" onclick="newwin(\''.base_url('index.php/thesa/tr/'.$id_c.'/'.checkpost_link($id_c)).'\',800,500);">';
				echo '<img src="'.base_url('img/icone/plus.png').'" width="32">';
				echo '</a>';
				echo '</h4>';
			...
			if ((count($notes)  +$editar) > 0) 
				{
					...
					echo ' <a href="#" onclick="newwin(\''.base_url('index.php/thesa/tf/'.$id_c.'/'.checkpost_link($id_c)).'\',800,500);">';
					echo '<img src="'.base_url('img/icone/plus.png').'" width="32">';
					echo '</a>';
					echo '</h4>';
			...
			if ((count($terms_al)  +$editar) > 0) 
				{
					...
					echo ' <a href="#" onclick="newwin(\''.base_url('index.php/thesa/te/'.$id_c.'/'.checkpost_link($id_c)).'\',800,500);">';
					echo '<img src="'.base_url('img/icone/plus.png').'" width="32">';
					echo '</a>';
					echo '</h4>';
			...
			if ((count($terms_hd)  +$editar) > 0) 
				{
					...
					echo ' <a href="#" onclick="newwin(\''.base_url('index.php/thesa/tz/'.$id_c.'/'.checkpost_link($id_c)).'\',800,500);">';
					echo '<img src="'.base_url('img/icone/plus.png').'" width="32">';
					echo '</a>';
					echo '</h4>';
		...
		<div class="col-md-2">
			...
			if ($editar == 1)
				{
				echo ' <a href="#" onclick="newwin(\''.base_url('index.php/thesa/timg/'.$id_c.'/'.checkpost_link($id_c)).'\',800,500);">';
				echo '<img src="'.base_url('img/icone/plus.png').'" width="32">';
				echo '</a>';
				}
			?>				

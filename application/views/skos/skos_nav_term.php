...
<ul class="nav nav-tabs">
  ...
  <li role="presentation" class="dropdown">
    ...
    <ul class="dropdown-menu">
    	<?php
		if ($ct_concept == '') {
			echo '<li role="presentation" ><a href="' . base_url('index.php/skos/concept_create/' . $lt_thesauros . '/' . checkpost_link($lt_thesauros) . '/' . $id_lt) . '">' . msg('Terms_create_concept') . '</a></li>';
		} else {
			echo '<li role="presentation" ><a href="' . base_url('index.php/skos/concept_subordinate/' . $lt_thesauros . '/' . checkpost_link($lt_thesauros) . '/' . $id_lt) . '">' . msg('Terms_subordinate') . '</a></li>';
		}
		?>
	</ul>
  </li>

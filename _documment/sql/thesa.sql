...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 06-Set-2021 às 14:49
...
CREATE TABLE IF NOT EXISTS `bugs` (
  `id_bug` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
('7rcgbt1l6j6477njfeb5lbfuddtgsl3s', '::1', 1630939769, );
...
--
-- Extraindo dados da tabela `mensagem_own`
--
...
DROP TABLE IF EXISTS `rdf_authority`;
CREATE TABLE IF NOT EXISTS `rdf_authority` (
  `id_au` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `rdf_literal`;
CREATE TABLE IF NOT EXISTS `rdf_literal` (
  `id_rl` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `rl_type` int(11) NOT NULL,
  `rl_value` longtext NOT NULL,
  `rl_lang` varchar(6) NOT NULL,
  UNIQUE KEY `id_rl` (`id_rl`),
  KEY `rl_index` (`id_rl`),
  KEY `rl_value` (`rl_value`(20))
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `rdf_literal_note`;
...
DROP TABLE IF EXISTS `rdf_literal_th`;
CREATE TABLE IF NOT EXISTS `rdf_literal_th` (
  ...
  KEY `lt_term` (`lt_term`,`lt_thesauros`)
...
DROP TABLE IF EXISTS `rdf_media`;
CREATE TABLE IF NOT EXISTS `rdf_media` (
  `id_rm` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `rdf_perfil_propriety`;
...
DROP TABLE IF EXISTS `rdf_resource`;
CREATE TABLE IF NOT EXISTS `rdf_resource` (
  `id_rs` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_rs` (`id_rs`),
  KEY `rs_prefix` (`rs_prefix`,`rs_propriety`)
...
(66, 16, 'nomen', '', 'C', 0, '', '', 1, ''),
(67, 3, 'Literal', '', 'C', 0, '', '', 1, ''),
(68, 13, 'coordinationOfActionProduct', '', 'P', 0, '', 'TR', 1, ''),
(69, 13, 'coordinationOfCauseEffect', '', 'P', 0, '', 'TR', 1, ''),
(70, 13, 'coordinationOfOpposition', '', 'P', 0, '', 'TR', 1, ''),
(71, 13, 'coordinationOfKinship', '', 'P', 0, '', 'TR', 1, ''),
(72, 13, 'coordinationOfPartOf', '', 'P', 0, '', 'TR', 1, ''),
(73, 13, 'coordinationOfProductCharacteristics', '', 'P', 0, '', 'TR', 1, ''),
(74, 4, 'broader.isTypeOf', 'narrower.hasTypeOf', 'P', 0, '', 'TG', 1, ''),
(75, 4, 'broader.isPartOfGeo', 'narrower.hasPartOfGeo', 'P', 0, '', 'TG', 1, ''),
(76, 4, 'broader.isPartOfBody', 'narrower.hasPartOfBody', 'P', 0, '', 'TG', 1, ''),
(77, 4, 'broader.isPartOfSocialStructure', 'narrower.hasPartOfSocialStructure', 'P', 0, '', 'TG', 1, ''),
(78, 4, 'broader.isPartOfDisciplina', 'narrower.hasPartOfDisciplina', 'P', 0, '', 'TG', 1, ''),
(79, 4, 'is_equivalent_another_language', '', 'P', 0, '', 'FE', 1, ''),
(80, 4, 'is_gerund', '', 'P', 0, '', 'FE', 1, ''),
(81, 4, 'is_feminine_of', '', 'P', 0, '', 'FE', 1, ''),
(82, 4, 'is_verbal_flexion', '', 'P', 0, '', 'FE', 1, ''),
(83, 4, 'objective_action', '', 'P', 0, '', 'TR', 1, ''),
(84, 4, 'property_action', '', 'P', 0, '', 'TR', 1, ''),
(85, 4, 'object_field', '', 'P', 0, '', 'TR', 1, ''),
(86, 4, 'action_against_agent', '', 'P', 0, '', 'TR', 1, ''),
(87, 4, 'property_object', '', 'P', 0, '', 'TR', 1, ''),
(88, 4, 'part_of_object', '', 'P', 0, '', 'TR', 1, ''),
(89, 4, 'material_product', '', 'P', 0, '', 'TR', 1, ''),
(90, 4, 'exactMatch', '', 'P', 0, '', 'LINKDATA', 1, ''),
(91, 4, 'closeMatch', '', 'P', 0, '', 'LINKDATA', 1, '');

-- --------------------------------------------------------

--
-- Estrutura da tabela `thesa`
--

DROP TABLE IF EXISTS `thesa`;
CREATE TABLE IF NOT EXISTS `thesa` (
  `id_thesa` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id_thesa` (`id_thesa`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `thesa`
--
...
CREATE TABLE IF NOT EXISTS `th_concept_term` (
  ...
  KEY `ct_concept` (`ct_concept`,`ct_concept_2`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estrutura da tabela `th_linkdata`
--

DROP TABLE IF EXISTS `th_linkdata`;
CREATE TABLE IF NOT EXISTS `th_linkdata` (
  `id_ld` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `ld_concept` int(11) NOT NULL,
  `ld_prop` char(250) COLLATE utf8_bin NOT NULL,
...
(1, 'Thesa', 'thesa', '', '', '0000001', '', 1, '9', '', 'M', '1', 'F', 20140706, 0, 0, 283, 0, 0, 0, 20170110, '#ADM#BIB', 'thesa', 'admin', '2020-01-01 03:00:00', '2020-01-01 03:00:00', '', 0, '00001');
...
--
-- Extraindo dados da tabela `users_group`
--

INSERT INTO `users_group` (`id_gr`, `gr_name`, `gr_hash`, `gr_library`, `gr_created`) VALUES
(1, 'Administradores', '#ADM', '4000', '2021-05-31 17:16:40'),
(2, 'Gerentes', '#GER', '4000', '2021-05-31 17:16:40');
...
--
-- Extraindo dados da tabela `users_group_members`
--

INSERT INTO `users_group_members` (`id_grm`, `grm_group`, `grm_user`, `grm_library`, `grm_created`) VALUES
(1, 1, 1, '4000', '2021-05-31 17:17:03');
...
CREATE TABLE IF NOT EXISTS `users_perfil` (
  `id_pe` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `pe_abrev` char(4) NOT NULL,
  `pe_descricao` char(100) NOT NULL,
  `pe_nivel` int(11) NOT NULL DEFAULT 9,
  UNIQUE KEY `id_pe` (`id_pe`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `users_perfil_attrib`;
CREATE TABLE IF NOT EXISTS `users_perfil_attrib` (
  `id_pa` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `pa_user` int(11) NOT NULL,
  `pa_perfil` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `works` (
  `id_w` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
